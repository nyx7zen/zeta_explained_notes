...
|----:|---------------|-------|
| 001 | Intro and the Basel Problem | [lec-001_notes.md](docs/contents/lec-001/lec-001_notes.md) |
...
| 018 | Growth Rates of Complex Functions (More Zeros = Faster Growth) | |
| 019 | Proof that the Number of Zeros in the Critical Strip Is O(T log T) | |
| 020 | Hadamard's Factorization of the Zeta Function | |
| 021 | The Riemann–von Mangoldt Formula Counts Zeros of the Zeta Function | |
...
| 026 | The Phragmén–Lindelöf Principle and the Order of Zeta in the Critical Strip | |
| 027 | The Prime Number Theorem (1/2) | |
| 028 | The Prime Number Theorem (2/2) | |
| 029 | Visualizing the Riemann Hypothesis | |
| 030 | The Riemann–Siegel Z Function Under the Riemann Hypothesis | |
| 031 | Dirichlet Series | |
| 032 | Möbius Inversion | |
| 033 | The Mertens Conjecture (and the Riemann Hypothesis) | |
...
| 041 | Riemann's Second Proof of the Functional Equation (via Jacobi Theta Functions) | |
...
| 050 | Littlewood's Log Log Log Bound on the Prime Number Theorem | |
...
| 067 | Historical Verification of the Riemann Hypothesis (1859–1936) | |
| 068 | Turing's Method of Verifying the Riemann Hypothesis (1953–Present) | |
| 069 | Deep Dive into Gamma (Weierstrass Product Formula) | |
| 070 | Proving Gamma Formulas (Euler's Reflection & Legendre's Duplication) | |
