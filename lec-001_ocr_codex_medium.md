...
The PDF has 26 image-only pages and no extractable text layer. Codex extracted the embedded page images and transcribed the visible English text and formulas from those images. No paid OCR API was used.
...
$$
= x(1 - x)\left(1 - \frac{x}{2}\right)
\left(1 - \frac{x}{3}\right)
\left(1 - \frac{x}{4}\right)
$$
